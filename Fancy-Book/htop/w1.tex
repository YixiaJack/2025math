...
\end{example}
 ...
 S_n=S_0+X_1+X_2+\cdots+X_n\\
    ...
    \begin{solution}
        ...
        \\$ P[\text{Best candidate is offered}]=\sum_{i=0}^{N}\underbrace{P[\text{best candidate is i}]}_{\frac{1}{N}}P[\text{Best candidate is offerd|Best candidate=i}] $ 
    \end{solution}
    \end{example}