...
\begin{proof}
  \begin{align*}{}{}
    ...
    (b): &\text{Let } A_1, A_2, \ldots \in \mathcal{H}. \text{ Then } A_1, A_2, \ldots \in \mathcal{F} \text{ and } A_1, A_2, \ldots \in \mathcal{G}.\\
    &\text{Since } \mathcal{F} \text{ and } \mathcal{G} \text{ are $\sigma$-fields, we have } \bigcup_i A_i \in \mathcal{F} \text{ and } \bigcup_i A_i \in \mathcal{G}.\\
  \end{align*}
\end{proof}
